...
def animate_simulation(sim, steps=100, interval=200, save_path=None):
    ...
    im = ax.imshow(img,extent=[-400, city.map.shape[0] * 10 + 100, -50, city.map.shape[1] * 10 + 120], zorder=0)
    ...
    custom_handle = Line2D([0], [0], marker='o', color='w', markerfacecolor='black', markersize=8, label='no-fly zones')
