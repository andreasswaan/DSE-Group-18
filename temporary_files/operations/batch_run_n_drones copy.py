...
for seed in seeds:
    txt_path = os.path.join(output_dir, f"variable_n_drones_seed{seed}_objective_weight{weight}_{depot_name}(final).txt")
    fig_path = os.path.join(output_dir, f"profit_vs_n_drones_seed{seed}_objective_weight{weight}_{depot_name}(final).pdf")
    profits = []
...
avg_fig_path = os.path.join(output_dir, f"avg_profit_vs_n_drones_objective_weight{weight}_{depot_name}(final).pdf")
plt.figure()
