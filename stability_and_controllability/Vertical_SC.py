...
Rt_fx = 3  # moment arm of the vertical thruster in m
Rt_fy = 3  # moment arm of the vertical thruster in m
Rt_bx = 3  # moment arm of the vertical thruster in m
Rt_by = 3  # moment arm of the vertical thruster in m
Rdx = 1  # moment arm of the Drag for the X axis in  m
rho = 1.2  # air density in kg/m^3
Dv = 0.4  # vertical propeller diameter in m
Dh = 0.4  # horizontal propeller diameter in m
Ct = 0.15  # propeller efficiency constant 0.11-0.15
Cq = 0.05  # aerodynamic drag for blade rotation constant 0.03
