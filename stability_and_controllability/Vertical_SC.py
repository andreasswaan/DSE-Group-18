...
zdot = 3  # Drone vertical velocity in m/s negative
z2dot = -0.25  # Drone vertical acceleration in m/s^2 negative
Iz = 0.4  # moment of inertia around Z axis ...
...
Rdx = 0.5  # moment arm of the Drag for the X axis in  m
rho = 1.2  # air density in kg/m^3
Dv = 0.406  # vertical propeller diameter in m
Dh = 0.4  # horizontal propeller diameter in m
Ct = 0.2  # propeller efficiency constant 0.11-0.15
Cq = 0.08  # aerodynamic drag for blade rotation constant
Cd = 1  # drag coefficient for the drone
S = 1  # area of the drone in the XY plane in m^2
g = 9.81
max_rpm = 6000
